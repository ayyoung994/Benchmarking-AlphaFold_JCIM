# 02_5FWJ_apo Trajectory Preparation

This directory contains the trajectory preprocessing workflow for the `02_5FWJ_apo` system in the KDM5C benchmarking study.

## System overview

`02_5FWJ_apo` represents the crystal-structure-based apo receptor system used for molecular dynamics simulation.
