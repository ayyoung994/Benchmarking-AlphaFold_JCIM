# 01_5FWJ_holo Trajectory Preparation

This directory contains the trajectory preprocessing workflow for the `01_5FWJ_holo` system in the KDM5C benchmarking study.

## System overview

`01_5FWJ_holo` represents the crystal-structure-based holo receptor system used for molecular dynamics simulation.

## Purpose

This folder stores the steps performed to generate analysis-ready trajectories and related files for the holo system after MD simulation.
