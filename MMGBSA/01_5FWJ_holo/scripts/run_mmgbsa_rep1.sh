...
gmx make_ndx -f md_rep1.tpr -n jmjc.ndx -o ../input/jmjc_mmpbsa.ndx
...
gmx trjconv -s md_rep1.tpr -f md_rep1.xtc -o md_20_60_center.xtc -tu ns -b 20 -e 60 -pbc mol -center -ur compact
