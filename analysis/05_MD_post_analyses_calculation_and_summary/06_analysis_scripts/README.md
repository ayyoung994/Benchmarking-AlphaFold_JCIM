...
This directory contains the notebook-based and script-based workflows used for the final cross-system post-MD calculations, summary generation, and figure preparation in the KDM5C benchmarking study.

These files were used to integrate processed outputs from the individual system-level analysis folders and to generate consolidated tables, comparative plots, and final summary figures across the benchmarked systems.
...
- and reproducibility of the final integrated analyses.
...
- and metal analysis outputs where applicable.

---

## Outputs

The scripts in this directory were used to generate the summary files and figures stored in the sibling directories of this module, including:
