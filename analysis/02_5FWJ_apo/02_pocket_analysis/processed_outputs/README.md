...
- `Table_Pocket_Stability_20-60ns_5FWJ_apo.csv`  
  Summary table containing the pocket stability metrics for the 5FWJ_apo system over the 20–60 ns analysis window.
