...
Processed output files are provided in `processed_outputs/`, including both replica-level analysis outputs and summarized results for the **02_5FWJ_apo** system.
