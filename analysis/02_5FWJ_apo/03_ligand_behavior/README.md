...
All raw outputs required for this analysis are provided in `raw_outputs/`, and the scripts required to reproduce the processed results and figures are provided in `scripts/`.
