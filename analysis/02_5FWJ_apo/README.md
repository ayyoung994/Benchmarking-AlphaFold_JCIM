...
This directory contains the post-simulation analysis workflows for the `02_5FWJ_apo` system in the KDM5C receptor-setup sensitivity study.
...
TThis system was used as one of the MD receptor setups in the comparative workflow and analyzed across independent MD replicas to assess structural stability, pocket behavior, ligand retention metrics, and interaction features relevant to receptor-setup sensitivity analysis.
...
This directory contains the organized post-MD analysis workflows for the **5FWJ metal-depleted** receptor setup. Depending on the specific submodule, analyses may include:
...
This system is organized as a standalone analysis module so that all post-simulation workflows for the `02_5FWJ_apo` condition can be tracked, documented, and reproduced independently from the other receptor setups.
...
- The internal label `apo` is retained for workflow continuity.
- In the manuscript, this system corresponds to **5FWJ metal-depleted**.
- This label should not be interpreted as a fully characterized biochemical apo enzyme state.
