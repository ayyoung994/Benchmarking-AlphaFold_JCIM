# Replica 3 — 01_5FWJ_holo

## Overview

This directory contains the files associated with **Replica 3** of the **01_5FWJ_holo** molecular dynamics workflow.
...
- This directory contains replica-specific simulation files for **Replica 3** of the **5FWJ holo** system.
